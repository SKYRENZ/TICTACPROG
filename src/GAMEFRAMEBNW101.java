...
public class GAMEFRAMEBNW101{

	 	JFrame GAMEframeBNW101;
	...
	private void winningGame()
	{
		//for player X only //
		if(b1==1 && b2==1 && b3==1) {
			JOptionPane.showMessageDialog(GAMEframeBNW101, "Player ONE Win!", " Tic tac Toe", JOptionPane.INFORMATION_MESSAGE);
			xCount1++;
		...
		//for player O only//
			...
			JOptionPane.showMessageDialog(GAMEframeBNW101, "Player ZERO Win!", " Tic tac Toe", JOptionPane.INFORMATION_MESSAGE);
			oCount1++;
			...
			JOptionPane.showMessageDialog(GAMEframeBNW101, "No one wins!", " Tic tac Toe", JOptionPane.INFORMATION_MESSAGE);
		}
	...
	public void initialize() {
		GAMEframeBNW101 = new JFrame();
		GAMEframeBNW101.setTitle("TIC-TAC-PROG");
		GAMEframeBNW101.setIconImage(Toolkit.getDefaultToolkit().getImage("C:\\Users\\Renz\\Downloads\\finalicon\\IP(Icon)\\1.png"));
		GAMEframeBNW101.setBounds(100, 100, 700, 650);
		GAMEframeBNW101.setDefaultCloseOperation(JFrame.EXIT_ON_CLOSE);
		GAMEframeBNW101.getContentPane().setLayout(new GridLayout(1, 0, 0, 0));
		GAMEframeBNW101.setLocationRelativeTo(null);
		GAMEframeBNW101.setResizable(false);
		...
		GAMEframeBNW101.getContentPane().add(MAINpanel);
